...
import { User, Branch, FerrySchedule, FerryScheduleCreate, FerryScheduleUpdate } from "@/types";
...
export default function SchedulesPage() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then(({ data }) => {
        setUser(data);
        return Promise.all([fetchSchedules(), fetchBranches()]);
      })
      .catch(() => router.push("/login"))
      .finally(() => setLoading(false));
  }, [router, fetchSchedules, fetchBranches]);
