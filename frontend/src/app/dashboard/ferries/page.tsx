...
import { User, Boat, BoatCreate, BoatUpdate } from "@/types";
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-800">Ferry Management</h2>
          ...
          <div className="flex flex-wrap items-end gap-3 mb-4">
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  {idOp === "between" && (
                    <>
                      <span className="flex items-center px-1.5 border-y border-gray-300 bg-gray-50 text-gray-400 text-xs">–</span>
                      <input
                        type="number"
                        min="1"
                        placeholder="To"
              ...
              <div className="relative flex-1 min-w-[200px]">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder={searchColumn === "name" ? "Search by name..." : searchColumn === "no" ? "Search by number..." : "Search by name or number..."}
                    value={searchInput}
                    onChange={(e) => {
                      const val = e.target.value;
                      setSearchInput(val);
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                <tr>
                  ...
                  <th onClick={() => handleSort("no")} className="text-left px-6 py-3 font-semibold text-gray-600 cursor-pointer select-none hover:text-blue-700">Number{sortIndicator("no")}</th>
              ...
              <tbody>
                {tableLoading ? (
                  ...
                  <tr>
                    <td colSpan={5} className="text-center py-8 text-gray-400">
                      No boats found. Click &quot;+ Add Boat&quot; to register one.
                    </td>
                  </tr>
                ) : (
                  boats.map((boat) => (
                    ...
                    >
                      <td className="px-6 py-4 text-gray-500">{boat.id}</td>
                      <td className="px-6 py-4 font-medium text-gray-800">{boat.name}</td>
                      <td className="px-6 py-4 text-gray-600">{boat.no}</td>
